...
public class OrderCompletedViaSplitPage {
	private AndroidDriver driver;

	public OrderCompletedViaSplitPage(AndroidDriver driver) {
		this.driver = driver;
	}

	public void queuedSplitOrderList() throws InterruptedException {
		Thread.sleep(1000);
		...
		WebElement customerCardSplit = driver
				.findElement(By.xpath("//android.view.View[contains(@content-desc, 'YadhiComplete Automation')]"));
		customerCardSplit.click();
		Thread.sleep(1000); // Optional wait
	...
	public void splitOrder() throws InterruptedException {
		WebElement yesButton = driver.findElement(By.xpath("//android.widget.Button[@content-desc='Yes']"));
		yesButton.click();
		Thread.sleep(1000);
		WebElement firstEditBox = driver.findElement(
				AppiumBy.androidUIAutomator("new UiSelector().className(\"android.widget.EditText\").instance(0)"));
		firstEditBox.click();
		firstEditBox.clear();
		firstEditBox.sendKeys("5");
		Thread.sleep(1000);
		WebElement secondEditBox = driver.findElement(
				AppiumBy.androidUIAutomator("new UiSelector().className(\"android.widget.EditText\").instance(1)"));
		secondEditBox.click();
		secondEditBox.clear();
		secondEditBox.sendKeys("5");
		WebElement splitButton = driver.findElement(By.xpath("//android.widget.Button[@content-desc='Split Order']"));
		splitButton.click();
		Thread.sleep(3000);
		System.out.println("TEST PASSED: Order is splitted successfully.");
	}
